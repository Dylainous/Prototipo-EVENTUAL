...
// 👇 Agrega 'Alojamiento' aquí para que aparezca en los botones de filtro
const _categorias = ['Alimentación','Sonido','Decoración','Transporte','Seguridad','Entretenimiento','Alojamiento','Otros'];
...
class _ProviderFormState extends State<_ProviderForm> {
  ...
  double _calificacion = 0; // <-- 1. AGREGA ESTA VARIABLE
  ...
  void _submit() async {
    ...
    try {
      await widget.api.post('/providers', {
        ...
        'calificacion': _calificacion, // <-- 2. AGREGA ESTO AL BODY
      });
      ...
      child: Form(key: _formKey, child: SingleChildScrollView(child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            // Usamos la misma lista global, sin escribirla a mano
            items: _categorias
          ...
          const SizedBox(height: 12),
          Text('Calificación inicial: ${_calificacion.toStringAsFixed(1)} / 5.0',

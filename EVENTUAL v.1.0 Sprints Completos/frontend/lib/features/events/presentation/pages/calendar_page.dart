    ...
    return Scaffold(
      ...
      body: BlocBuilder<EventsBloc, EventsState>(
        ...
        buildWhen: (previous, current) {
          // Solo redibujamos el calendario si el estado es de carga o de lista.
          // Ignoramos estados individuales como detalles de un solo evento.
          return current is EventsLoaded || 
                 current is EventsLoading || 
                 current is EventsEmpty;
        },
...
class _EventTile extends StatelessWidget {
  ...
  void _showEventDetail(BuildContext context, EventEntity e) {
    showModalBottomSheet(
      ...
      builder: (modalContext) => Padding( // <-- AQUÍ
            ...
            if (rol == 'Presidente' || rol == 'Tesorero')
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    // 1. Guardamos el navegador usando el modalContext
                    final navigator = Navigator.of(modalContext); 
                    
                    // 2. Cerramos el modal de forma segura
                    navigator.pop(); 
                    
                    // 3. Abrimos la nueva ventana de cotizaciones
                    navigator.push(
                      MaterialPageRoute(

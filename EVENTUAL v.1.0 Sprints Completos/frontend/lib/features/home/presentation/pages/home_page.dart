...
import '../../../broadcast/presentation/bloc/broadcast_bloc.dart';
import '../../../broadcast/presentation/pages/broadcast_page.dart';
import '../../../broadcast/presentation/pages/notifications_page.dart';

import '../../../execute_event/presentation/bloc/execute_event_bloc.dart';
import '../../../execute_event/presentation/pages/execute_event_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final isSecretario = rol == 'Secretario';
    ...
    final screens = [
      ...
      if (isPresidente)
        BlocProvider(
          create: (_) => sl<ExecuteEventBloc>(),
          child: const ExecuteEventPage(),
        ),
      if (isTesorero)
        BlocProvider(
